...
export const Faqs = ({ ...props }) => {
  ...
  return (
    <div className="flex w-full flex-col 2xl:flex-row h-[700px] 2xl:h-[550px] rounded-3xl">
      ...
      <div
        ref={faqContainer}
        className="flex w-full 2xl:w-3/4 justify-end text-black tracking-tight h-[550px] 2xl:h-full pl-10"
      >
        {props.data.map((faq, index) => (
          ...
          >
            ...
            <div className="absolute w-28 h-full overflow-hidden z-10 whitespace-nowrap">
              <div
                className="absolute w-96 -rotate-90 origin-[0%_0%] mt-[440px] top-20 left-6 transition-all min-w-[500px] ease-out duration-500 font-semibold text-2xl"
                style={{
            ...
            <div
              ...
              className="absolute left-24 ease-out duration-500 w-full h-full opacity-1 transition-all"
            >
